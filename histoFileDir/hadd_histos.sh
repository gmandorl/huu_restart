...
cp -f DYJetsToLL_M-105To160-amcatnloFXFX_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root  DYJetstoLL_amc_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root
# cp -f DYJetsToLL_M-105To160-madgraphMLM_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root  DYJetstoLL_amc_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root

# cp -f DYJetstoLL_amc_Filter105_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root  DYJetstoLL_amc_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root   

# cp -f DYJetstoLL_amc_M-50_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root  DYJetstoLL_amc_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root
...
# hadd -f DYJetstoLL_amc_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root DY0JetsToLL_M_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root DY1JetsToLL_M_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root DY2JetsToLL_M_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root DY3JetsToLL_M_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root DY4JetsToLL_M_mu_QCDScale${QCDcorrection}_JES${JEScorrection}_v25_reskim.root
